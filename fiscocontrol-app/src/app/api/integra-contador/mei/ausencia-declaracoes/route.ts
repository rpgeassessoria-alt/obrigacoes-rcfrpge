...
import { AusenciaDeclaracoesMeiService } from '../../../../../lib/integra-contador/mei/ausencia-declaracoes';
...
export async function GET(request: Request) {
  ...
  try {
    const data = await AusenciaDeclaracoesMeiService.consultarAusencia(cnpj);
