...
export default function AlvaraSanitarioPage() {
    return (
        <div className="page-content">
            <div className="page-header">
                <div>
                    <h1 className="page-title">Alvará Sanitário</h1>
                    <p className="page-sub">Licença sanitária emitida pela Vigilância Sanitária Municipal ou Estadual</p>
                </div>
