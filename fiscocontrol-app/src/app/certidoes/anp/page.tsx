    ...
    return (
        <div className="page-content">
            <div className="page-header">
                <div>
                    <h1 className="page-title">ANP — Agência Nacional do Petróleo</h1>
                    <p className="page-sub">Autorização e regularidade junto à Agência Nacional do Petróleo, Gás Natural e Biocombustíveis</p>
                </div>
            ...
            <div className="card">
                <div className="card-title">Autorizações Cadastradas</div>
                <p style={{ color: 'var(--text-muted)', fontSize: '14px' }}>
                    Nenhuma autorização cadastrada ainda. Clique em "Novo Cadastro" para adicionar.
                </p>
            </div>
