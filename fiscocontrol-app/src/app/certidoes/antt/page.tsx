    ...
    return (
        <div className="page-content">
            <div className="page-header">
                <div>
                    <h1 className="page-title">ANTT — Agência Nacional de Transportes Terrestres</h1>
                    <p className="page-sub">Regularidade e habilitação junto à Agência Nacional de Transportes Terrestres</p>
                </div>
            ...
            <div className="card">
                <div className="card-title">Habilitações Cadastradas</div>
                <p style={{ color: 'var(--text-muted)', fontSize: '14px' }}>
                    Nenhuma habilitação cadastrada ainda. Clique em "Novo Cadastro" para adicionar.
                </p>
            </div>
