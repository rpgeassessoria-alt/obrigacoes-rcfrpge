...
export default function AlvaraLocalizacaoPage() {
    return (
        <div className="page-content">
            <div className="page-header">
                <div>
                    <h1 className="page-title">Alvará de Localização e Funcionamento</h1>
                    <p className="page-sub">Licença municipal para exercício de atividades comerciais, industriais ou de serviços</p>
                </div>
            ...
            <div className="card">
                <div className="card-title">Alvarás Cadastrados</div>
                <p style={{ color: 'var(--text-muted)', fontSize: '14px' }}>
                    Nenhum alvará cadastrado ainda. Clique em "Novo Cadastro" para adicionar.
                </p>
            </div>
