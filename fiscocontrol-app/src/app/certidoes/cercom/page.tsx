...
export default function CercomPage() {
    return (
        <div className="page-content">
            <div className="page-header">
                <div>
                    <h1 className="page-title">Cercom — Corpo de Bombeiros</h1>
                    <p className="page-sub">Certificado de Conformidade emitido pelo Corpo de Bombeiros Militar</p>
                </div>
            ...
            <div className="card">
                <div className="card-title">Certificados Cadastrados</div>
                <p style={{ color: 'var(--text-muted)', fontSize: '14px' }}>
                    Nenhum certificado cadastrado ainda. Clique em "Novo Cadastro" para adicionar.
                </p>
            </div>
